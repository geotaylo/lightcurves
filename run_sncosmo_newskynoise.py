...
def get_skynoise(n):
    ...
    skynoise = []
    for i in range(n):
        sigma_psf = exponweib.rvs(461.87921971531955, 0.6860198725258686, loc=-0.869494090011727, scale=0.43722954355185195,
        size = 1)

        # Find probability of distribution giving sigma_psf or less
        percent = exponweib.cdf(sigma_psf, 461.87921971531955, 0.6860198725258686, loc=-0.869494090011727, scale=0.43722954355185195)
        ...
        sigma_pixel = exponweib.ppf(percent_new, 26.47111428278329, 1.014405795857852, loc=-16.985179115012222, scale=9.81027950453267)
...
def fit_util_lc(data, index, folder, coords_in, z, t0):
    ...
    return fitted_params, fitted_t0, fitted_errors
>>>>>>> 127039188ce8ca93e1613faf18e456f36fb9ce88
